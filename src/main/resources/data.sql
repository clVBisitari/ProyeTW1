...
VALUES (null, 'contacto1@unlam.edu.ar', 'Diego', 'Uno', 23456789, 0.0, 'password1', false, false);

INSERT INTO Usuario (id, email, nombre, apellido, dni, saldo, password, esAdmin, enSuspencion)
VALUES (null, 'contacto2@unlam.edu.ar', 'MAriano', 'Dos', 34567890, 0.0, 'password2', false, false);
