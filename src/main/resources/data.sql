INSERT INTO Usuario(id, email,nombre, apellido, dni, saldo, password, esAdmin, enSuspencion) VALUES(null, 'test@unlam.edu.ar','Juan','Perez',38498777,10500.0, 'test', true,false);
